#ifndef TRAIN_FLOAT8_HPP
#define TRAIN_FLOAT8_HPP
...
void train_bfloat(	size_t epoch,
	...
	for(auto& batch : data_loader) {
		...
		// Convert data and target to bf16 and long
		torch::Device device = model->parameters().front().device();
		data = data.to(device, torch::kFloat8_e5m2);

...
// Custom functions
#include "test_float8.hpp"
#include "train_float8.hpp"

// Dataset path
#define DATASET_PATH				"../dataset"

// Load
#define NET_LOAD_FILENAME_BFLOAT		"../net/example/model_epoch_0_float8.pt"

// Save
#define NET_SAVE_PATH				"../net/example/"
#define NET_EPOCH_FILENAME_BFLOAT	"model_epoch_%zu_float8.pt"
...
int main() {
	...
	if (torch::cuda::is_available()) {
		std::cout << "Found CUDA-enabled device, but will not use it" << std::endl;
		// gpu = true;
	}
	...
	model_float->to(torch::kFloat8_e5m2);
	if (gpu) {

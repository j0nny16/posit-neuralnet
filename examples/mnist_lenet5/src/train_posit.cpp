...
// Dataset path
#define DATASET_PATH                BASE_DIR "posit-neuralnet/examples/mnist_lenet5/dataset"

// Load paths
#define NET_LOAD_FILENAME_FLOAT     BASE_DIR "posit-neuralnet/examples/mnist_lenet5/net/example/model_epoch_0_float.pt"
#define NET_LOAD_FILENAME_POSIT     BASE_DIR "posit-neuralnet/examples/mnist_lenet5/net/example/model_epoch_0_posit.dat"

// Save paths
#define NET_SAVE_PATH               BASE_DIR "posit-neuralnet/examples/mnist_lenet5/net/example/"

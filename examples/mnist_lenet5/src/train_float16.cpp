...
// Custom functions
#include "test_float16.hpp"
#include "train_float16.hpp"

// Dataset path
#define DATASET_PATH				"../dataset"

// Load
#define NET_LOAD_FILENAME_BFLOAT		"../net/example/model_epoch_0_float16.pt"

// Save
#define NET_SAVE_PATH				"../net/example/"
#define NET_EPOCH_FILENAME_BFLOAT	"model_epoch_%zu_float16.pt"

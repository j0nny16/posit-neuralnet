...
// Load paths (Passe hier ggf. die Epoch-Nummer an, die du testen willst)
#define NET_LOAD_FILENAME_FLOAT     BASE_DIR "posit-neuralnet/examples/mnist_lenet5/net/example/model_epoch_10_float.pt"
